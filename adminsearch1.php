...
<h1 align=center> All Entered Properties </h1>
				...
				while($row = $result->fetch_object())
				{
					 ...
					 $Status=$row->Status;
       				 ...
       				 echo("		  <tr>
                                  ...
                                  if($Status == "Block")
                                  	echo("<td><a href='Unblock.php?propid=$Propertyid'>$Status</a></td>");
                                  else
                                  echo("<td><a href='Block.php?propid=$Propertyid'>$Status</a></td>");
